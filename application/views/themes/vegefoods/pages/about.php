...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/tv.png'); ?>');">
    <div class="container">
...
<section class="ftco-section">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Terbaru </h3>
          <span>Langsung dari Pusat</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Kualitas Original</h3>
          <span>KLangsung dari Pusat88k</span>
        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
