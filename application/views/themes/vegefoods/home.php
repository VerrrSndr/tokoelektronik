...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/smartphone.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Alat Elektronik Terbaik</h1>
            <p><a href="#products" class="btn btn-primary">Beli Sekarang</a></p>
          </div>
 ...
 -->
  ...
  <div class="container">
    ...
    <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
        <span class="subheading">Produk dengan Harga Terbaik dari yang Terbaik</span>
